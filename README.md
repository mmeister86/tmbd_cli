...
```bash
git clone https://github.com/matthias/tmdb-cli.git
cd tmdb-cli
make build
make install
```
...
Vorkompilierte Binaries für verschiedene Plattformen findest du unter [Releases](https://github.com/matthias/tmdb-cli/releases).
